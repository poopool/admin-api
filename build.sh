...
#Mapping build ARGs
APL_ADMIN_API_TAG=${APL_ADMIN_API_TAG}
...
#Pulling apl-admin-api repo
wget https://applariat:$BB_API_KEY@bitbucket.org/applariat/apl-admin-api/get/$APL_ADMIN_API_TAG.zip

mkdir -p /usr/src/app
bsdtar -xf $APL_ADMIN_API_TAG.zip -s'|[^/]*/||' -C /usr/src/app
cd /usr/src/app/
ls -alh
